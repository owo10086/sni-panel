...
export function generateInstallScript(defaultPanelUrl: string, options: AgentInstallScriptOptions = {}): string {
  ...
  const lines = [
    ...
    '',
    '  RELEASE_VERSION="$FXP_RELEASE_VERSION" download_release_binary "forwardx-udp2raw-linux-${GO_ARCH}" "$UDP2RAW_BIN" "ForwardX UDP over TCP runtime" "0" || \\',
    '    echo "[警告] UDP over TCP runtime 安装失败，仅影响 UDP over TCP 功能"',
    '',
    '  return 0',
    '}',
    '',
    ...
    '    RELEASE_VERSION="$FXP_RELEASE_VERSION" download_release_binary "forwardx-udp2raw-linux-${GO_ARCH}" "$UDP2RAW_BIN" "ForwardX UDP over TCP runtime" "0" || true',
    '    install_deps',
    '    sync_system_time',
    '    if ! install_runtime; then',
