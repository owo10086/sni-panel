...
const tables: TableDef[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      c("sourcePort", "int", { notNull: true }), c("sni", "text"), c("sniSplitterPort", "int"),
      c("rateLimitMbps", "int", { notNull: true, default: 0 }), c("maxConnections", "int", { notNull: true, default: 0 }),
      c("targetIp", "text", { notNull: true }),
